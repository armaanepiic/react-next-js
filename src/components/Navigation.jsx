...
// reusable navbar
const listOfNavigation = ["Products", "Pricing", "Docs"];
const navItems = <NavItems items={listOfNavigation} />;

export default function Navigation() {
  return (
    // Navigation
    <div
      className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0
           flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0"
    >
